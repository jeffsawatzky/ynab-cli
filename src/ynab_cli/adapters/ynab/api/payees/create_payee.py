...
from ynab_cli.adapters.ynab.models.post_payee_wrapper import PostPayeeWrapper
...
def _get_kwargs(
    plan_id: str,
    *,
    body: PostPayeeWrapper,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/plans/{plan_id}/payees".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx2.Response
    ...
    if response.status_code == 201:
        response_201 = SavePayeeResponse.from_dict(response.json())
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | SavePayeeResponse
    """
