...
def _get_kwargs(
    ...
    *,
    ...
    type_: GetTransactionsByCategoryType | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/plans/{plan_id}/categories/{category_id}/transactions".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type_ (GetTransactionsByCategoryType | Unset):
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | HybridTransactionsResponse
    """
