...
from ynab_cli.adapters.ynab.models.get_transactions_by_account_type import GetTransactionsByAccountType
...
def _get_kwargs(
    ...
    *,
    ...
    type_: GetTransactionsByAccountType | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/plans/{plan_id}/accounts/{account_id}/transactions".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type_ (GetTransactionsByAccountType | Unset):
