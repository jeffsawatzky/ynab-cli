...
from ynab_cli.adapters.ynab.models.plan_settings_response import PlanSettingsResponse
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/plans/{plan_id}/settings".format(
...
) -> ErrorResponse | PlanSettingsResponse | None:
    if response.status_code == 200:
        response_200 = PlanSettingsResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx2.Response
) -> Response[ErrorResponse | PlanSettingsResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | PlanSettingsResponse
    """
