...
from ynab_cli.adapters.ynab.models.plan_detail_response import PlanDetailResponse
...
) -> ErrorResponse | PlanDetailResponse | None:
    if response.status_code == 200:
        response_200 = PlanDetailResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx2.Response
) -> Response[ErrorResponse | PlanDetailResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | PlanDetailResponse
    """
