...
from ynab_cli.adapters.ynab.models.post_category_group_wrapper import PostCategoryGroupWrapper
...
def _get_kwargs(
    plan_id: str,
    *,
    body: PostCategoryGroupWrapper,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/plans/{plan_id}/category_groups".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx2.Response
    ...
    if response.status_code == 201:
        response_201 = SaveCategoryGroupResponse.from_dict(response.json())
