...
from ynab_cli.adapters.ynab import models, rest
from ynab_cli.adapters.ynab.api_response import ApiResponse
from ynab_cli.adapters.ynab.api_response import T as API_RESPONSE_T
from ynab_cli.adapters.ynab.configuration import Configuration
from ynab_cli.adapters.ynab.errors import (
    ApiError,
    ApiValueError,
)
...
class ApiClient:
    ...
    NATIVE_TYPES_MAPPING: ClassVar[dict[str, type]] = {
        "int": int,
    ...
    def response_deserialize(
        self, response_data: rest.RESTResponse, response_types_map: dict[str, API_RESPONSE_T] | None = None
    ) -> ApiResponse[API_RESPONSE_T]:
        ...
        if response_data.data is None:
            raise AssertionError("RESTResponse.read() must be called before passing it to response_deserialize()")
    ...
    def deserialize(self, response_text: str, response_type: str, content_type: str | None):
        ...
        if content_type is None:
            ...
            raise ApiError(status=0, reason=f"Unsupported content type: {content_type}")
    ...
    def __deserialize_date(self, string):
        ...
        try:
            ...
            raise rest.ApiError(status=0, reason=f"Failed to parse `{string}` as date object") from e
    ...
    def __deserialize_datetime(self, string):
        ...
        try:
            ...
            raise rest.ApiError(status=0, reason=(f"Failed to parse `{string}` as datetime object")) from e
    ...
    def __deserialize_enum(self, data, klass):
        ...
        try:
            ...
            raise rest.ApiError(status=0, reason=(f"Failed to parse `{data}` as `{klass}`")) from e
