...
T = TypeVar("T", bound="PostScheduledTransactionWrapper")
...
class PostScheduledTransactionWrapper:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_scheduled_transaction_wrapper = cls(
            scheduled_transaction=scheduled_transaction,
        )

        post_scheduled_transaction_wrapper.additional_properties = d
        return post_scheduled_transaction_wrapper
