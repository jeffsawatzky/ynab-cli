...
class SavePayee(BaseModel):
    ...
    name: Annotated[str, Field(strict=True, max_length=500)] | None = Field(
        default=None, description="The name of the payee. The name must be a maximum of 500 characters."
    )
