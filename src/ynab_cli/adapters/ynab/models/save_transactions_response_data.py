...
class SaveTransactionsResponseData(BaseModel):
    ...
    transactions: list[TransactionDetail] | None = Field(
        default=None, description="If multiple transactions were specified, the transactions that were saved"
    )
    duplicate_import_ids: list[StrictStr] | None = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "transaction": TransactionDetail.from_dict(obj["transaction"])
