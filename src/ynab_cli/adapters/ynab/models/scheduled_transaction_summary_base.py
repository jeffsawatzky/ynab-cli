...
T = TypeVar("T", bound="ScheduledTransactionSummaryBase")
...
class ScheduledTransactionSummaryBase:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        scheduled_transaction_summary_base = cls(
            id=id,
            date_first=date_first,
            date_next=date_next,
            frequency=frequency,
        ...
        scheduled_transaction_summary_base.additional_properties = d
        return scheduled_transaction_summary_base
