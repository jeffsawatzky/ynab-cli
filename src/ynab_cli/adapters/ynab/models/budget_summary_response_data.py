...
class BudgetSummaryResponseData(BaseModel):
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "budgets": [BudgetSummary.from_dict(_item) for _item in obj["budgets"]]
                if obj.get("budgets") is not None
                else None,
                "default_budget": BudgetSummary.from_dict(obj["default_budget"])
                if obj.get("default_budget") is not None
                else None,
            }
        )
        return _obj
