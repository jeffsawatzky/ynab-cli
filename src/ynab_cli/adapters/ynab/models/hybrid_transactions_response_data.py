...
class HybridTransactionsResponseData(BaseModel):
    ...
    server_knowledge: StrictInt | None = Field(default=None, description="The knowledge of the server")
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "transactions": [HybridTransaction.from_dict(_item) for _item in obj["transactions"]]
