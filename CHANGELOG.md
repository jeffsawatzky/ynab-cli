...
- fix unused payees and categories. we now have to specify a since_date when getting transactions

## v0.8.0 (2026-09-04)

### Feat

- update ynab sdk to latest

### Fix

- update deps and replace httpx with httpx2

## v0.7.3 (2026-05-29)

### Refactor

- fix some lint issues and update deps
